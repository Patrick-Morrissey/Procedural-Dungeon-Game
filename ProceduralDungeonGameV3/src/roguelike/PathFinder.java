...
// We need something that charges straight for us,
// something that peruses us relentlessly, a simple-minded foe that we don’t want to run
// into. For that we need a way to find a path to the player.
// The monsters are only going to pathfind to the player if they see him

// This pathfinding class is using a HashMap of points rather than an
// array so we don’t have to worry about the world size or anything like that. This will take
// up less memory and handle arbitrarily large maps but it will be much much slower
